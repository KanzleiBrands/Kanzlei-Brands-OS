...
export function MobileSidebarShell({ sidebar }: { sidebar: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-72 max-w-[85vw] flex-col overflow-y-auto border-r bg-card p-4 transition-transform duration-200 md:static md:z-auto md:w-56 md:max-w-none md:translate-x-0 ${
